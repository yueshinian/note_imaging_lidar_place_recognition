...
void cloud_handler(const sensor_msgs::PointCloud2ConstPtr &cloud_msg)
{
    ...
    // control insertation frequency控制频率
    ...
    //时间戳，索引，图像强度，一维数组存储点云xyz_identity信息
...
int main(int argc, char **argv)
{
    ...
    fsSettings["num_bri_features"] >> NUM_BRI_FEATURES;//200
    fsSettings["num_orb_features"] >> NUM_ORB_FEATURES;//500
